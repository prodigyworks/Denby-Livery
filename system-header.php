...
<div id="templatemo_top_panel">
	<div id="templatemo_top_section">
		<div class="slideshow">
			<img src="images/animations/animation12.jpg" style="display:block" />
			<img src="images/animations/animation1.jpg" />
			<img src="images/animations/animation2.jpg" />
			<img src="images/animations/animation3.jpg" />
			<img src="images/animations/animation4.jpg" />
			<img src="images/animations/animation5.jpg" />
			<img src="images/animations/animation6.jpg" />
			<img src="images/animations/animation7.jpg" />
			<img src="images/animations/animation8.jpg" />
			<img src="images/animations/animation9.jpg" />
			<img src="images/animations/animation10.jpg" />
			<img src="images/animations/animation11.jpg" />
		</div>
		...
		<div id="site_title">
  		...
  		<div id="loginLink">
  			<?php 
				if (! isAuthenticated()) {
		  			echo "<a title='Log in' href='#' onclick='$(\"#loginFormContainer\").dialog(\"open\");'><img border=0 width=16 height=16 src='images/icon_login.png' /></a>\n";
